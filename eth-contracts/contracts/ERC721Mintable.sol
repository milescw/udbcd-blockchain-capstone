...
contract Ownable {
   ...
   /**
    ...
    /**
     * @return True if `msg.sender` is the contract owner.
     */
    ...
    /**
     * @dev Allows the current owner to transfer contract control to a newOwner.
    ...
    /**
     * @dev Transfers contract control to a newOwner.
     * @param newOwner The address to transfer ownership to.
     */
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
     ...
     * Reverts back if the token ID does not exist
     * @param tokenId uint256 token ID to set its URI
     */
 ...
 * a Custom ERC721 non-fungible token contract for my udacity blockchain capstone project.
 */
