...
contract('ERC721Mintable', async (accounts) => {
    ...
    describe('match erc721 spec', function () {
        ...
        it(`1. Test to check if correct isOwner()`, async function () {
        ...
        it(`2. Test to return correct name()`, async function () {
        ...
        it(`3. Test to return correct symbol()`, async function () {
        ...
        it(`4. Test to return correct baseTokenURI()`, async function () {
        ...
        it(`5. Test if should work pause/unpause `, async function () {
        ...
        it('6. Test should mint 10 tokens', async function () {
        ...
        it('7. Test if total supply returned', async function () {
        ...
        it('8. Test should get token balance', async function () {
        ...
        it('9. Test should return token uri', async function () {
            ...
            //console.log(status)
            assert.equal(status, expectedTokenUri, "token uri is not correct");

        })

        it('10. Test should transfer token from one owner to another', async function () {
            const tokenId = config.firstTokenId
            // first approve
            ...
            assert.equal(status3, config.account_two, "new token owner is not correct");
        })
    });

    describe('have ownership properties', function () {

        it('11. Test should return contract owner', async function () {
            // Get owner
            let status = await config.myToken.owner.call();
            assert.equal(status, config.owner, "account[0] is owner");
        })

        it('12. Test should fail minting when address is not contract owner', async function () {
