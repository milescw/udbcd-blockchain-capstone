...
contract('SolnSquareVerifier', async (accounts) => {
    ...
    describe('match ERC721 specs', function () {
        ...
        it(`2. Test to see if returned the correct name()`, async function () {
        ...
        it(`3. Test to see if returned the correct symbol()`, async function () {
        ...
        it(`4. Test to see if returned the correct baseTokenURI()`, async function () {
        ...
        it('5. Test to see if returned contract owner', async function () {
            // Get owner
            let status = await config.solnSquareVerifier.owner.call();
            assert.equal(status, config.owner, "account[0] is owner");
        })

        it('6. Test to mint an ERC721 token', async function () {
        ...
        it('7. Test to return the total supply', async function () {
        ...
        it('8. Test a new solution was added', async function () {
